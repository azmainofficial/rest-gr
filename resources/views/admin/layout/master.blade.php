              ...
              <div class="profile-box ml-15">
                <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                  ...
                  <div class="profile-info">
                    <div class="info">
                      <div class="image">
                        <img src="https://media.licdn.com/dms/image/D5603AQE-QwZwHErGPA/profile-displayphoto-shrink_200_200/0/1709564558331?e=2147483647&v=beta&t=diOiE5lvJxWU460aZ9gaByvVZ6z52VO6feUeHKg62Pg" alt="" />
                      </div>
                      <div>
                        <h6 class="fw-500">Azmain Sheikh</h6>
                        <p>Admin</p>
                      </div>
                    </div>
                  </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                  <li>
                    <div class="author-info flex items-center !p-1">
                      <div class="image">
                        <img src="{{ asset('ui/backend/assets/images/profile') }}/profile-image.png" alt="image">
                      </div>
                      <div class="content">
                        <h4 class="text-sm">Azmain Sheikh</h4>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="icon-card mb-30">
              ...
              <div class="content">
                <h6 class="mb-10">Utility</h6>
                <h3 class="text-bold mb-10">5,000 Tk</h3>
              </div>
            </div>
            <!-- End Icon Cart -->
          </div>
