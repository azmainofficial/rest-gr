...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/line-icons/2.0/LineIcons.css">
</head>
    ...
    <main class="main-wrapper">
        ...
        <section class="section">
            <div class="container-fluid">
                ...
                @endif
                <a href="{{ route('admin.projects.addProperty', $project_id) }}"
                    class="main-btn primary-btn rounded btn-hover">Add Property unit</a>
                                           ...
                                           @foreach ($projects as $key=>$project )
                                            <tr>
                                                <td class="min-width">
                                                    <div class="lead">
                                                        <div class="lead-text">
                                                            <p><a href="">{{ $project->property_name }}</a></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="min-width">
                                                    <p>{{ $project->property_rent }}</p>
                                                </td>
                                                <td class="min-width">
                                                    <p>{{ $project->property_utility_cost }}</p>
                                                </td>

                                                <td class="min-width">
                                                    <p>{{ $project->floor_number }}</p>
                                                </td>
                                                <td class="min-width">
                                                    <p>{{ $project->block }}</p>
                                                </td>
                                                ...
                                                @if($project->status==='0')
                                                <td class="min-width">
                                                    <span class="status-btn active-btn">Aailable</span>
                                                </td>
                                                @elseif($project->status==='1')
                                                <td class="min-width">
                                                    <span class="status-btn active-btn">Booked</span>
                                                </td>
                                                @endif
                                                <td>
                                                    <div class="action d-flex align-items-center">
                                                        <button class="text-warning p-2">
                                                            <i class="fa-solid fa-pen-to-square"></i>
                                                        </button>
                                                        <button class="text-danger p-2">
