                        ...
                        <div class="single-notification">
                            <div class="notification">
                                <div class="image warning-bg">
                                    llll
                                    <img src="{{ asset('images/uploads/' . $client->formal_picture) }}"
                                        alt="">
                                </div>
                                <a href="#0" class="content col-md-8">
                                    <h6>A Request from <span class="Name"> {{ $client->full_name }}</span></h6>
                                    <p class="text-sm text-gray">Project - <span>{{ $client->project_name }}</span>
                                    </p>
                                    <p class="text-sm text-gray">Unit - <span>{{ $client->unit_name }}</span></p>
                                    <p class="text-sm text-gray">Floor - <span> {{ $client->floor }}</span></p>
                                    <p class="text-sm text-gray">Block - <span> {{ $client->block }}</span></p>
                                    <p class="text-sm text-gray">Phone - <span>{{ $client->phone }}</span></p>
                                    <p class="text-sm text-gray">Email - <span>{{ $client->email }}</span></p>
                                    <p class="text-sm text-gray">Gender - <span>{{ $client->gender }}</span></p>
                                    <p class="text-sm text-gray">Occupation - <span>{{ $client->occupation }}</span>
                                    </p>
                                    <p class="text-sm text-gray">Short Details -
                                        <span>{{ $client->short_details }}</span>
                                    </p>
                                    <span class="text-sm text-medium text-gray">{{ $client->time_ago }}</span>
                                </a>
                                <div class="nid col-md-4">
                                    @foreach (explode('|', $client->nid_picture) as $image)
                                        <img src="{{ asset('images/uploads/' . $image) }}" alt=""
                                            width="300px" class="my-2">
                                    @endforeach
                                </div>
                            </div>
                            <div class="action">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="moreAction">
                                    ...
                                    <li class="dropdown-item">
                                        <a href="{{ route('admin.addUser',$client->id) }}" class="text-gray">Confirm and processed</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
