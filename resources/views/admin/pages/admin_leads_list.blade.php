    ...
    <main class="main-wrapper">
        ...
        <section class="section">
            <div class="container-fluid">
                ...
                {{-- <a href="" class="main-btn primary-btn rounded-full btn-hover my-3">Add Lead</a> --}}
                @if (session('success'))
                                        ...
                                        <tbody>
                                            @foreach ($users as $key => $user)
                                                <tr>
                                                    ...
                                                    @if ($user->full_name && $user->full_name2)
                                                        <td class="min-width">
                                                            <p>Grouped</p>
                                                        </td>
                                                    ...
                                                    @else
                                                        <td class="min-width">
                                                            <span class="status-btn active-btn">Inactive</span>
                                                        </td>
                                                    @endif
                                                    <td>
                                                        <div class="action">
