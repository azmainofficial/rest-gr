    ...
    <main class="main-wrapper">
        ...
        <section class="section">
            <div class="container-fluid">
                ...
                @endif
                <a href="{{ route('admin.projects.create') }}" class="main-btn primary-btn rounded btn-hover">Add
                    Project</a>
                                                ...
                                                <tr>
                                                    <td class="min-width">
                                                        <div class="lead">
                                                            <div class="lead-text">
                                                                <p><a
                                                                        href="{{ route('admin.projects.unitList', $project->id) }}">{{ $project->project_name }}</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
