                            ...
                            <div class="profile-box ml-15">
                                <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                                    ...
                                    <div class="profile-info">
                                        <div class="info">
                                            <div class="image">
                                                <img src="{{ asset('formalPicture') }}/{{ $data->formal_picture }}"
                                                    alt="" />
                                            </div>
                                            <div>
                            ...
                            <div class="invoice-card card-style mb-30">
                                <div class="invoice-header">
                                    ...
                                    <div class="invoice-date">
                                        <p><span>Date :</span> {{ $report->created_at->format('d-m-Y') }}</p>
                                        <p><span>Due Date :</span>
                                            {{ $report->created_at->addDays(5)->format('d-m-Y') }}
                                        </p>
                                        <p><span>ID:</span> #5467{{ $report->user->id }}</p>
                                    </div>
                                </div>
                                <div class="invoice-address">
                                    ...
                                    <div class="address-item">
                                        ...
                                        <p class="text-sm">
                                            {{ $report->user->project_name }}
                                        </p>
                                        <p class="text-sm">
                                            {{ $report->user->present_address }}
                                        </p>
                                        <p class="text-sm">
                                            <span class="text-medium">Email:</span>
                                            {{ $report->user->email }}
                                ...
                                <div class="table-responsive">
                                    <table class="invoice-table table">
                                        ...
                                        @php
                                            $assignedMonthsArray = json_decode($report->assigned_months, true);
                                        @endphp
                                        <tbody>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="text-sm">
                                                        {{ $assignedMonthsArray[0] }}
                                                    </p>
                                                </td>
                                                <td></td>
                                                <td>
                                                    <p class="text-sm">{{ $report->user->confirm_rent }} tk</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="text-sm">{{ $report->user->utility_cost }} tk</p>
                                                </td>
                                            </tr>
